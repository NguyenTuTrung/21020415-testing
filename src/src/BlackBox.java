...
class BlackBox {
    ...
    void testCase1() {
        ...
        assertEquals("Dau vao khong hop le", p.isRent(p));
    }
    @Test
    void testCase2() {
        Person p = new Person(1, "Junior");
        assertEquals("Khong thue", p.isRent(p));
    }
    @Test
    void testCase3() {
        Person p = new Person(20, "Junior");
        assertEquals("Thue ban thoi gian", p.isRent(p));
    }
    @Test
    void testCase4() {
        Person p = new Person(30, "Junior");
        assertEquals("Thue toan thoi gian", p.isRent(p));
    }
    @Test
    void testCase5() {
